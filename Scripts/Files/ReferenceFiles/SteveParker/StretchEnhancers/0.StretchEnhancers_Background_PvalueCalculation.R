...
{
  setwd("/Users/skn/Desktop/Lab/Diabetic_Versus_Non-Diabetic/ReferenceFiles/SteveParker/StretchEnhancers/")
  ...
  for(i in 1:length(Tissues$V1))
  {
    ...
    readFile <- paste("/Users/skn/Desktop/Lab/Diabetic_Versus_Non-Diabetic/ReferenceFiles/SteveParker/StretchEnhancers/", Tissues$V1[i], sep="")
